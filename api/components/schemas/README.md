...
- `schemas-02.yaml`: `OnboardingDraftWrite`, `OnboardingPublishRequest`, `Money`, `PaymentMethod` with provider display name, `BalanceResponse`, `ResetStrategy`, `SquadProduct`, `Combo`, `CatalogNode`, `Catalog`, `ComboWrite`, `SquadProductWrite`
