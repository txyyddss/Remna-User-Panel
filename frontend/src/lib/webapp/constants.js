...
export const LOCALE_KEY_ALIASES = {
  ...
  admin_wa_appearance_panel_name: "wa_appearance_panel_name",
  admin_wa_panel_name_description: "wa_panel_name_description",
  admin_wa_panel_name_placeholder: "wa_panel_name_placeholder",
