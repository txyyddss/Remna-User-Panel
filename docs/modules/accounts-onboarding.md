...
- Usernames match `^[a-zA-Z0-9_-]{3,36}$`, are unique, and cannot change after reservation. Local lookup plus Remnawave preflight provide fast feedback; Remnawave `A019` resolves an upstream duplicate race.
