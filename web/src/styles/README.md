...
- `overlays-01.css` resolves Telegram safe-area bounds while retaining Nuxt UI's native centered position for teleported modals, provides translucent high-contrast dark-glass overlay surfaces/backdrops, symmetric opt-in centered modal headers, and responsive drawer/slideover layouts. Its reduced-transparency fallback restores opaque elevated surfaces without changing overlay behavior.
