...
- `CommunityView.vue` is the thin Community route view for entitlement-gated Telegram group and channel access.
...
- `OnboardingView.vue` hosts the resumable intro, username, and agreement flow.
