...
- `IntroSequence.vue`, `MembershipPanel.vue`, `UsernamePanel.vue`, and `AgreementPanel.vue` render each step; agreement cards render server-authored color and an optional localized page title.
