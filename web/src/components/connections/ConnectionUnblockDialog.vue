...
<template>
  <UModal v-model:open="open" :title="$t('connections.unblockTitle')" :description="block ? $t('connections.unblockDescription', { ip: block.ip }) : ''" :dismissible="!busy" :close="{ 'data-haptic': '' }" :ui="{ footer: 'justify-end' }">
    <template #body>
