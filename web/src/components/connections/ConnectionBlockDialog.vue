...
<template>
  <UModal v-model:open="open" :title="$t('connections.blockTitle')" :description="target ? $t('connections.blockDescription', { ip: target.connection.ip }) : ''" :dismissible="!busy" :ui="{ footer: 'justify-end' }">
    <template #body>
