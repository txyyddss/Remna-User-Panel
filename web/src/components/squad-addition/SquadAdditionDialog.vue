...
<template>
  <UModal v-model:open="open" :title="$t('home.squadAddition.title')" :description="$t('home.squadAddition.description')" :close="false" :ui="{ content: 'tg-glass-surface squad-addition-dialog__modal', header: 'tg-overlay-header--centered', wrapper: 'tg-overlay-copy--centered', footer: 'justify-end flex-wrap' }" scrollable>
    <template #body>
