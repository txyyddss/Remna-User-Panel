...
- `ActivityResultDialog.vue` presents authoritative results, including the reward returned by lucky draws, and mounts success feedback only for winning bets.
