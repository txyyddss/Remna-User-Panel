...
- `StatisticsGeocheckModal.vue` accepts the shared minimal node target and presents the on-demand cached SVG result for Statistics and Catalog with loading, unavailable, soft dismiss, wheel, centered pinch, pan, and double-tap zoom. Drag, wheel, and polling never trigger continuous feedback.
