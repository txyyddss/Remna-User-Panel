...
- `CryptoPaymentInstructions.vue` renders the exact crypto amount, address QR, copy action, countdown, explicit replacement, and user cancellation without exposing a provider URL.
