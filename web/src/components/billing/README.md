...
- `PaymentChannelStep.vue` renders the second Add TXB step with a separate amount field and channel grid, then starts or rechecks the provider operation without overlapping controls.
