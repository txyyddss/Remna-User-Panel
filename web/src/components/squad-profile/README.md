...
- `SquadProfileSummary.vue` renders compact generated facts, caller-owned name-tag, heading-meta, and facts slots, and safe extra Markdown. Its member presentation combines localized type and port speed beneath the squad name, enlarges the unframed profile icon, and suppresses redundant location facts; China routes keep carrier marks without abbreviation prefixes.
