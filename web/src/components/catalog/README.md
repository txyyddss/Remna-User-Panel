...
- `CatalogPage.vue` owns the four-step combo, squads, coupon, and review journey, its versioned user-scoped step restoration, and authoritative quote refresh when leaving squads or restoring later steps.
