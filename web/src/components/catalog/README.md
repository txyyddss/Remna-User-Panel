...
- `CatalogNodes.vue` presents the live server-projected accessible nodes with a country flag, traffic multiplier, provider name, and favicon fallback.
...
- `CatalogNodes.test.ts` verifies live provider name and favicon rendering.
