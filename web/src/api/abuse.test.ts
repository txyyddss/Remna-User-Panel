...
describe('abuse administration API mutations', () => {
  ...
  it('sends the required streak with every policy field', async () => {
    const policy: AbusePolicy = { outboundTags: ['direct', 'proxy-main'], globalEnabled: true, globalLimit: 50, streakSeconds: 75, warningValidityDays: 7, warningCooldownMinutes: 30, revision: 4 }
