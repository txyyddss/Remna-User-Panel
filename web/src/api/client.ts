...
export const api = {
  ...
  getNodeGeocheck: (nodeUuid: string, squadUuid?: string) => request<StatisticsNodeGeocheck>(`/api/v1/statistics/nodes/${encodeURIComponent(nodeUuid)}/geocheck`, { query: squadUuid ? { squadUuid } : undefined }),
