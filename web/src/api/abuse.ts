...
export interface AbusePolicy { outboundTag: string; globalEnabled: boolean; globalLimit: number; streakSeconds: number; warningValidityDays: number; warningCooldownMinutes: number; revision: number }
