...
- `bash install.sh test` prints up to 1,000 raw Xray core log lines from `docker exec remnanode xlogs` without installing, uploading, or changing reporter state.
